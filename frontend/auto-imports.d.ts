...
declare global {
  ...
  const handleNumberInput: typeof import('./src/utils/input-number')['handleNumberInput']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly handleNumberInput: UnwrapRef<typeof import('./src/utils/input-number')['handleNumberInput']>
